...
//				URL url = new URL("http://localhost:8080/icpakportal/getreport?bookingRefId=U5G0Yi5WPoeUIf1V&action=GETPROFORMA");
				URL url = new URL("http://www.icpak.com:8080/icpakportal/api/users");
				//URL url = new URL("http://localhost:8080/icpakportal/index.html");
