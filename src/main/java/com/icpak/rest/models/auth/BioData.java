...
public class BioData {
	...
	@Column(name = "`Search Name`", columnDefinition = "varchar(50)")
	// - Full Names Caps
	private String searchName;

	@Column(name = "`Name 2`", columnDefinition = "varchar(40)")
	// - Empty
	...
	@CollectionTable(name = "user_salutation", joinColumns = @JoinColumn(name = "userid", referencedColumnName = "id", nullable = false))
	@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
