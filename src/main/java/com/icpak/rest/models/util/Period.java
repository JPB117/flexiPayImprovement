...
/**
 * Program Calendar Periods</p> All the program targets/ outcomes/ finances are
 * managed within a single calendar period, usually 1st Jan - 31st Dec or 1 July
 * - 30 June
 * 
 * @author duggan
 *
...
public class Period extends PO {
	...
	public boolean equals(Object obj) {
		...
		if (period.getId() != null && getId() != null) {
			...
			return period.getStartDate().equals(startDate)
