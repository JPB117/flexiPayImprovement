...
public class RoleResourceImpl implements RoleResource {
	...
	public List<RoleDto> getAll(@QueryParam("offset") Integer offset,
		...
		return helper.getAllRoles("", offset, limit);
	}
	...
	@Path("/{roleId}")
	@Produces(MediaType.APPLICATION_JSON)
	@ApiOperation(value="Get a role by roleId", response=RoleDto.class, consumes=MediaType.APPLICATION_JSON)
	public RoleDto getById( 
			@ApiParam(value="Role Id of the role to fetch", required=true) @PathParam("roleId") String roleId) {
		
		return helper.getRoleById(roleId);
	}

	@POST
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	@ApiOperation(value="Create a new role", response=RoleDto.class, consumes=MediaType.APPLICATION_JSON)
	public RoleDto create(RoleDto role) {
		
		return helper.createRole(role);
	}
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	@ApiOperation(value="Update an existing role", response=RoleDto.class, 
	...
	public RoleDto update( 
		...
		return helper.updateRole(roleId, role);
	}
