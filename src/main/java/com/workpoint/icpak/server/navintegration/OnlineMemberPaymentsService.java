...
public class OnlineMemberPaymentsService
    extends Service
{
    ...
    private final static QName ONLINEMEMBERPAYMENTSSERVICE_QNAME = new QName("urn:microsoft-dynamics-schemas/page/online_member_payments", "Online_Member_Payments_Service");
     ...
     * 
     * @return
     *     returns OnlineMemberPaymentsPort
     */
    @WebEndpoint(name = "Online_Member_Payments_Port")
    public OnlineMemberPaymentsPort getOnlineMemberPaymentsPort() {
        return super.getPort(new QName("urn:microsoft-dynamics-schemas/page/online_member_payments", "Online_Member_Payments_Port"), OnlineMemberPaymentsPort.class);
    }
    ...
    public OnlineMemberPaymentsPort getOnlineMemberPaymentsPort(WebServiceFeature... features) {
        return super.getPort(new QName("urn:microsoft-dynamics-schemas/page/online_member_payments", "Online_Member_Payments_Port"), OnlineMemberPaymentsPort.class, features);
    }
