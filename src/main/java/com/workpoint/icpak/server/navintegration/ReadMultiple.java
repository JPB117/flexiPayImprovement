 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/online_member_payments}Online_Member_Payments_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<OnlineMemberPaymentsFilter> filter;
     ...
     * {@link OnlineMemberPaymentsFilter }
     * 
     * 
     */
    public List<OnlineMemberPaymentsFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<OnlineMemberPaymentsFilter>();
        }
        return this.filter;
    }
