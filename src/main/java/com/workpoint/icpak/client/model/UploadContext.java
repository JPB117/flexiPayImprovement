...
public class UploadContext {
	...
	public enum UPLOADACTION {
		GETPROFORMA, ATTACHDOCUMENT, UPLOADBPMNPROCESS, UPLOADCHANGESET, IMPORTFORM, UPLOADUSERIMAGE, UPLOADLOGO, UPLOADDOCFILE, UPLOADOUTPUTDOC, GENERATEOUTPUT, IMPORTGRIDDATA, UPLOADCPD, GETSTATEMENT, GETCPDSTATEMENT, DownloadCertGoodStanding, GETATTACHMENT, GETDELEGATESREPORT, UPLOADIDPHOTOCOPY
	}
