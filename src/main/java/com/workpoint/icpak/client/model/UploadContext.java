package com.workpoint.icpak.client.model;
...
public class UploadContext {
	...
	public enum UPLOADACTION {
		GETOFFLINESQL, GETPROFORMA, ATTACHDOCUMENT, UPLOADBPMNPROCESS, UPLOADCHANGESET, IMPORTFORM, UPLOADUSERIMAGE, UPLOADLOGO, UPLOADDOCFILE, UPLOADOUTPUTDOC, GENERATEOUTPUT, IMPORTGRIDDATA, UPLOADCPD, GETSTATEMENT, GETCPDSTATEMENT, DownloadCertGoodStanding, GETATTACHMENT, GETDELEGATESREPORT, UPLOADIDPHOTOCOPY, UPLOADEDUCATIONATTATCHMENTS, UPLOADTRAININGATTATCHMENTS, GENERICATTATCHMENTS, GETTRANSACTIONSREPORT, SYNCTOSERVER
	}
	...
	/**
	 * This method converts all values in context into url parameters format i.e
	 * key=value&key2=value&key3=value etc
	 * 
	 * @return
	 */
